        ...
        <form>
            ...
            <div class="section" id="appointment">
                ...
                @foreach ($records as $r)
                    ...
                    <div class="form-row">
                        <label class="label">Time: {{ date('h:i a', strtotime($r->start)) }}</label>
                    </div>

                    <div class="form-row">
                        <label class="label">Handled By: {{ $r->fname . ' ' . $r->mname . ' ' . $r->lname }}</label>
                    </div>

                    <div class="form-row">
                        <label class="label">Service: {{ $r->name }}</label>
                    </div>
                    <div class="sep"></div>
